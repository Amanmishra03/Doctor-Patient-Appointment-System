...
# to retrieve doctor appointments
...
# retrieve all appointment requests for a specific doctor
...
# to retrieve registered patients from a database table named patients. 
...
# to retrieve registered doctors from a database table named doctors.
...
#  to retrieve doctor names along with their specialties from a database table named doctors. 
